...
const errores400 = Object.freeze({
  ...
  SOLO_EL_COMPRADOR_PUEDE_CANCELAR_UN_PEDIDO: SoloElCompradorPuedeCancelarUnPedido.name,
  SOLO_EL_VENDEDOR_PUEDE_ENVIAR_UN_PEDIDO: SoloElVendedorPuedeEnviarUnPedido.name,
